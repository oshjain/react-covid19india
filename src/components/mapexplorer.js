      ...
      <div className="map-stats">
        ...
        <div className="stats is-blue">
          ...
          <div className="stats-bottom">
            ...
            <h6>[{currentHoveredRegion.active ? ((currentHoveredRegion.active / currentHoveredRegion.confirmed) * 100).toFixed(2) + "%" : ''}]</h6>
          </div>
        </div>
        ...
        <div className="stats is-green">
          ...
          <div className="stats-bottom">
            ...
            <h6>[{currentHoveredRegion.recovered ? ((currentHoveredRegion.recovered / currentHoveredRegion.confirmed) * 100).toFixed(2) + "%": ''}]</h6>
          </div>
        </div>
        ...
        <div className="stats is-gray">
          ...
          <div className="stats-bottom">
            ...
            <h6>[{currentHoveredRegion.deaths ? ((currentHoveredRegion.deaths / currentHoveredRegion.confirmed) * 100).toFixed(2) + "%": ''}]</h6>
          </div>
        </div>
      </div>
